...
//7.We no longer want to be responsible for the users’ phone numbers. 
//Please create a function that will loop through the array 
//and set the phone numbers = null. Call the function.
...
const getUserInfo = (email, newUsername) => {
    users.forEach(user => {
        if (user.email == "Telly.Hoeger@billy.biz") {
